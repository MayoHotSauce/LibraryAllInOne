...
<body>
    <div class="book-card">
        <img src="https://fr.web.img4.acsta.net/pictures/17/06/22/13/50/542868.jpg" alt="Dragon of Lab RPL">
        <h2>Five Night At Freddy's 4</h2>
    ...
    <div class="book-details" style="display: none;">
        <div class="book-info">
            <img src="https://fr.web.img4.acsta.net/pictures/17/06/22/13/50/542868.jpg" alt="Dragon of Lab RPL">
            <h2>Five Night At Freddy's 4 </h2>
            <p><strong>Penulis:</strong> Scott Cawthon</p>
            <p><strong>Penerbit:</strong> Scott Cawthon</p>
            <p><strong>Tahun Terbit:</strong> 20??</p>
            <p><strong>Rating:</strong> 
                ...
                <i class="fas fa-star"></i>
                <i class="fas fa-star-half-alt"></i>
                <span class="rating-details">(Jumlah Ulasan: 988K)</span>
            </p>
        </div>
        <div class="book-description">
            <h3>Deskripsi Buku:</h3>
            <p>Five Nights at Freddy’s 4 (FNAF 4) adalah salah satu buku dalam seri Five Nights at Freddy’s yang ditulis oleh Scott Cawthon, Berceritakan Mimpi Buruk
                seorang anak Kecil pada Tahun 1987 Di Fazbear Entertainment
            </p>
        </div>
        <div class="book-action">
            <p><strong>Jumlah Buku Tersisa:</strong> 1000</p>
